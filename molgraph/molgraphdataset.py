# AUTOGENERATED! DO NOT EDIT! File to edit: MolGraphDataset.ipynb (unless otherwise specified).

__all__ = ['TARGET2TYPE', 'TYPE2TARGET', 'CHIRAL_DICT', 'HYBRIDIZATION', 'EDGE_FEATURES', 'ELEMENTS', 'encode_onehot',
           'AtomFeaturizer', 'BondFeaturizer', 'MolecularGraph', 'MolecularDataset', 'save_df', 'MolecularGraphDataset',
...
class AtomFeaturizer:
    def __init__(self):
        ...
        self.ATOM_FEATURES = {
            'atomic_num': [1,5,6,7,8,9,15,16,17,35,53],
            'degree': [0, 1, 2, 3, 4, 5],
...
class MolecularGraph:
    ...
    def mol_to_graph(self, max_nodes=None):
        ...
        #self.pair_indices = torch.zeros((self.n_nodes, 2)).long()
