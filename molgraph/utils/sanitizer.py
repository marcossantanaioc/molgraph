# AUTOGENERATED! DO NOT EDIT! File to edit: MolClearner.ipynb (unless otherwise specified).

__all__ = ['convert_smiles', 'mol_to_inchi', 'build_inchi_dict', 'find_inchikey_duplicates', 'add_nitrogen_charges',
           'getlargestfragment', 'remove_unwanted', 'get_mixture', 'normalize_mol', 'get_stereo_info', 'remove_racemic',
...
def process_duplicates(data, smiles_col:str, act_col:str, id_col:str, stereo_col:str='Stereo', keep:str='first'):
    """
